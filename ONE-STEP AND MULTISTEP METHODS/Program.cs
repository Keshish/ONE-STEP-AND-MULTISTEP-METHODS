...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        var eulerParameters = new InputParameters(x0, y0, T, 1000); 
        ...
        var adamsParameters = new InputParameters(x0, y0, T, 1000); 
        ...
        var exactParameters = new InputParameters(x0, y0, T, 10000000); 
        ...
        var exactResults = exactSimulationManager.RunSimulationAndGetResults(); 
        ...
        foreach (int N in NValues)
        {
            ...
            var testResults = testSimulationManager.RunSimulationAndGetResults(); 

            double error = Math.Abs(testResults - exactResults); 
